...
test('Reliability-Maturity-Endurance Test', async ({ page }) => {
    ...
    console.log(`Failed Iterations: ${failCount}`);
    console.log(`Fastest Load Time: ${fastestLoadTime} ms`);
    console.log(`Slowest Load Time: ${slowestLoadTime} ms`);
    ...
    const txtContent = results.map(r =>
        ...
        `Successful Iterations: ${successCount}\n` +
        `Failed Iterations: ${failCount}\n` +
